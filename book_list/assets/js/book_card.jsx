...
class BookCard extends React.Component {
    bookList(booklists, book, session) {
        return _.find(booklists, (item) => {
            return book.id === item.book_id && session.user_id === item.user_id.toString()
        });
    }

    render() {
        let {book, session, authenticated, booklists} = this.props;
            ...
            <div className="book-info">
                ...
                <div className="buttons">
                    ...
                    {authenticated ? <BookListButton
                        ...
                        book_list={authenticated ? this.bookList(booklists, book, session) : null}
                    /> : null}
                </div>
            </div>
        </div>;
